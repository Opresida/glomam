  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-bottom">
        <div className="section-inner">
          <div className="footer-copy">© 2025 GLOMAM — Grande Loja Maçônica do Amazonas · Tradição · Regularidade · Progresso</div>
