          ...
          <div className="eye-section reveal">
            <div className="eye-wrap">
              ...
              <svg className="eye-rays" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <g stroke="rgba(211,165,76,0.22)" strokeWidth="1" fill="none">
              ...
              <svg className="eye-svg" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <polygon points="100,24 184,162 16,162" stroke="rgba(211,165,76,0.7)" strokeWidth="2" fill="rgba(211,165,76,0.04)" />
                <path d="M60,100 Q100,58 140,100 Q100,142 60,100Z" stroke="rgba(211,165,76,0.85)" strokeWidth="1.5" fill="rgba(10,12,16,0.9)" />
                <circle className="iris-anim" cx="100" cy="100" r="16" stroke="var(--gold)" strokeWidth="1.5" fill="rgba(211,165,76,0.08)" />
                <circle className="pupil-anim" cx="100" cy="100" r="6" fill="var(--gold)" opacity="0.85" />
                <circle cx="100" cy="100" r="24" stroke="rgba(211,165,76,0.18)" strokeWidth="1" fill="none" />
              </svg>
            </div>
          </div>
