...
- [x] **Filtro (ano/mês) + visão Trilha** ✓ *2026-07-23* — na rota `/noticiasinstitucionais`: barra sticky com alternador **Grade | Trilha** + chips de **Ano** (2017–2025) e **Mês** (meses vazios desabilitados). **Trilha** = linha do tempo sinuosa (espinha dourada central, marcos de ano, cards alternando esquerda/direita com conectores curvos), da 1ª à última publicação. Componente `TrilhaInstitucional.jsx`; itens da trilha ficam visíveis por padrão (sem `.reveal`, pra não travar em opacity:0 na troca de visão). Validado desktop + mobile.
